...
class FunctionsPage {
  constructor(page) {
    ...
    // Function type selection (OToggleGroupItem toggle options — wrapper divs carry the data-test).
    // The inner OToggleGroupItem renders data-state="on|off" — we read it
  ...
  async expectJsRadioSelected() {
    // OToggleGroupItem exposes via data-state="on|off".
